...
export type GetMovesQuery = { __typename?: 'World__Query', movesModels?: { __typename?: 'MovesConnection', edges?: Array<{ __typename?: 'MovesEdge', node?: { __typename?: 'Moves', player?: any | null, remaining?: any | null, last_direction?: any | null } | null } | null> | null } | null };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getMoves(variables: GetMovesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetMovesQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetMovesQuery>(GetMovesDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getMoves', 'query', variables);
    },
