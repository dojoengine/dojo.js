...
export const compiledAbi = {
    ...
    manifest: {
        world: {
            class_hash:
                "0x685ed02eefa98fe7e208aa295042e9bbad8029b0d3d6f0ba2b32546efe0a1f9",
            address:
                "0x58565b92f55fb07b53940b4b7eea3df2ac2878210e5c7a4c68201e8c511a546",
            seed: "dojo_starter",
            name: "Dojo starter",
            entrypoints: [
                "uuid",
        ...
        contracts: [
            {
                address:
                    "0x49f9b281bb08aea6d745f28cf31dd529348b04a21d9a5ae1ef19197665c02da",
                class_hash:
                    "0x28059bba1d3a76ca9ee42d2b4fdabb41604cd6fbd95e1e33b220c6e8060b1eb",
                abi: [
                    {
                        type: "impl",
                        name: "actions__ContractImpl",
                    ...
                    },
                    {
                        ...
                        name: "ActionsImpl",
                        interface_name:
                            "dojo_starter::systems::actions::IActions",
                    },
                    {
                        type: "enum",
                        name: "dojo_starter::models::Direction",
        ...
        models: [
            {
                members: [],
                class_hash:
                    "0x2e99a114233093bc3ffbebd3772d7e3bb4089810e35989e14b399dceca393d0",
            ...
            },
            {
                members: [],
                class_hash:
                    "0x526723ade660d893ae0f7a5c756c97664fa94ef8cae34b078a032f59a62840",
            ...
            },
            {
                members: [],
                class_hash:
                    "0x18b0c5c5c7d2574023d174ac2326cff5e8c2ba62672bc032803bed54515fb58",
            ...
            },
            {
                members: [],
                class_hash:
                    "0x4518971c1abf10a6c1c40f8f72fc34816dee4752d66f0f2b9d29a62f4fb3310",
