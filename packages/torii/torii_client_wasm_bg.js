...
function __wbg_adapter_36(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures__invoke1_mut__hf31a506167c50058(arg0, arg1, addHeapObject(arg2));
}

function __wbg_adapter_39(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures__invoke1_mut__h37f5d4bbd5e26d29(arg0, arg1, addHeapObject(arg2));
}
...
*/
export function createClient(initial_entities_to_sync, config) {
    const ptr0 = passArrayJsValueToWasm0(initial_entities_to_sync, wasm.__wbindgen_malloc);
...
function __wbg_adapter_167(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h77c2dd2090875058(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
export class Client {
    ...
    */
    getModelValue(model, keys) {
        try {
            ...
            wasm.client_getModelValue(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1);
    ...
    */
    addEntitiesToSync(entities) {
        const ptr0 = passArrayJsValueToWasm0(entities, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.client_addEntitiesToSync(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
    ...
    * @returns {Promise<void>}
    */
    removeEntitiesToSync(entities) {
        const ptr0 = passArrayJsValueToWasm0(entities, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.client_removeEntitiesToSync(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
    ...
    */
    onEntityChange(entity, callback) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.client_onEntityChange(retptr, this.__wbg_ptr, addHeapObject(entity), addHeapObject(callback));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
                throw takeObject(r0);
...
export function __wbg_log_89dbdd10da3e7582(arg0, arg1) {
...
export function __wbindgen_closure_wrapper1052(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 354, __wbg_adapter_36);
    return addHeapObject(ret);
};

export function __wbindgen_closure_wrapper1501(arg0, arg1, arg2) {
