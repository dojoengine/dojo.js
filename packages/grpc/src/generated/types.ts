        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* types.HashedKeysClause hashed_keys */ 1:
                    message.clauseType = {
                        oneofKind: "hashedKeys",
                        hashedKeys: HashedKeysClause.internalBinaryRead(
                            reader,
                            reader.uint32(),
                            options,
                            (message.clauseType as any).hashedKeys
                        ),
                    };
                    break;
                case /* types.KeysClause keys */ 2:
                    message.clauseType = {
                        ...
                        keys: KeysClause.internalBinaryRead(
                            ...
                            reader.uint32(),
                            options,
                            (message.clauseType as any).keys
                        ),
                    };
                    break;
                case /* types.MemberClause member */ 3:
                    message.clauseType = {
                        ...
                        member: MemberClause.internalBinaryRead(
                            ...
                            reader.uint32(),
                            options,
                            (message.clauseType as any).member
                        ),
                    };
                    break;
                case /* types.CompositeClause composite */ 4:
                    message.clauseType = {
                        ...
                        composite: CompositeClause.internalBinaryRead(
                            ...
                            reader.uint32(),
                            options,
                            (message.clauseType as any).composite
                        ),
                    };
                    break;
                default:
                ...
                case /* types.Primitive primitive */ 1:
                    message.valueType = {
                        ...
                        primitive: Primitive.internalBinaryRead(
                            ...
                            reader.uint32(),
                            options,
                            (message.valueType as any).primitive
                        ),
                    };
                    break;
...
class ControllerQuery$Type extends MessageType<ControllerQuery> {
    ...
    internalBinaryWrite(
        ...
        for (let i = 0; i < message.contractAddresses.length; i++)
            writer
                .tag(1, WireType.LengthDelimited)
                .bytes(message.contractAddresses[i]);
...
class TokenBalanceQuery$Type extends MessageType<TokenBalanceQuery> {
    ...
    internalBinaryWrite(
        ...
        for (let i = 0; i < message.accountAddresses.length; i++)
            writer
                .tag(1, WireType.LengthDelimited)
                .bytes(message.accountAddresses[i]);
    ...
    internalBinaryWrite(
        ...
        if (message.transactionType !== "")
            writer
                ...
                .string(message.transactionType);
...
class TransactionFilter$Type extends MessageType<TransactionFilter> {
    ...
    internalBinaryWrite(
        ...
        for (let i = 0; i < message.callerAddresses.length; i++)
            writer
                .tag(2, WireType.LengthDelimited)
                .bytes(message.callerAddresses[i]);
        ...
        for (let i = 0; i < message.modelSelectors.length; i++)
            writer
                .tag(5, WireType.LengthDelimited)
                .bytes(message.modelSelectors[i]);
