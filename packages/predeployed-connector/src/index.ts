...
// @ts-ignore
export class PredeployedAccountsConnector extends Connector {
    constructor(private options: PredeployedAccountsConnectorOptions) {
        super();
    }
    ...
    async chainId(): Promise<bigint> {
        // @ts-ignore
        return await this.options.account.getChainId();
    }
